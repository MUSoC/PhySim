...
public:
    ...
    void setupUi(QMainWindow *Simulator)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/rec/icons/export.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionExport->setIcon(icon1);
        actionPlay = new QAction(Simulator);
        actionPlay->setObjectName(QStringLiteral("actionPlay"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/rec/icons/button_play_green.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPlay->setIcon(icon2);
        actionStop = new QAction(Simulator);
        actionStop->setObjectName(QStringLiteral("actionStop"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/rec/icons/media_playback_stop.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionStop->setIcon(icon3);
        actionQuit = new QAction(Simulator);
        actionQuit->setObjectName(QStringLiteral("actionQuit"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/rec/icons/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        comboBox->setGeometry(QRect(10, 300, 86, 25));
